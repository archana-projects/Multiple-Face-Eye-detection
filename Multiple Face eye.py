...
face_cascade = cv2.CascadeClassifier(r"C:\Users\kumar\.vscode\FULLSTACK DATASCIENCE\OPEN CV(COMPUTER VISION)\HAARCASADE OPENCV\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"C:\Users\kumar\.vscode\FULLSTACK DATASCIENCE\OPEN CV(COMPUTER VISION)\HAARCASADE OPENCV\haarcascade_eye.xml")
